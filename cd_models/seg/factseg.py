...
from cd_models import initializer as init
from .farseg import FPN, ResNetEncoder,AsymmetricDecoder
...
class FactSeg(nn.Layer):
    """
     @ARTICLE{9497514,
        ...
        number={},
        pages={1-16},
        keywords={Semantics;Image segmentation;Task analysis;Remote sensing;Optimization;Feature extraction;Decoding;Deep learning;high-resolution remote sensing (HRS) imagery;semantic segmentation;small objects},
