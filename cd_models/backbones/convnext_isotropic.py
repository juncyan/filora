...
class ConvNeXtIsotropic(nn.Layer):
    r""" ConvNeXt
    ...
    def __init__(self, in_chans=3, num_classes=1000, 
        ...
        dp_rates=[x.item() for x in paddle.linspace(0, drop_path_rate, depth)] 
...
def convnext_isotropic_small(pretrained=False, **kwargs):
    ...
    if pretrained:                                     
        ...
        checkpoint = paddle.hub.load_state_dict_from_url(url=url, map_location="cpu")
